#!/usr/bin/env python3
"""
my_agent_s11.py - Autonomous Agents (your implementation)

s11 新增机制：让队友从“被动等待指派”升级为“主动找活干”。

核心包含三部分：
  1) WORK/IDLE 双阶段循环
  2) IDLE 阶段轮询 inbox + 任务看板自动认领
  3) 上下文压缩后的身份重注入

运行测试：python3 test_s11.py
"""
...
# ============================================================
# [s11] IDENTITY REINJECTION — restore teammate identity
# ============================================================
...
# ============================================================
# [s11] TEAMMATE MANAGER — autonomous loop with idle polling
# ============================================================
class TeammateManager:
    ...
    def _exec(self, sender: str, tool_name: str, args: dict) -> str:
        ...
        if tool_name == "claim_task":
            # Task: teammate 通过 claim_task 工具认领任务
